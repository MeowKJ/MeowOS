...
test "$(git check-attr eol -- config/meow-mindustry-sudoers | awk '{print $3}')" = lf
...
grep -q 'KillMode=control-group' systemd/meow-mindustry.service
